...
source("R/04_alignment_results.R")
source("R/05_blast_run.R")
source("R/06_diamond_run.R")
source("R/07_makeseqdb.R")
source("R/08_aligner_dispatch.R")
source("R/09_aligner_params.R")
source("R/10_search_strategy.R")
source("R/11_user_preferences.R")
